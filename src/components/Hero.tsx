      ...
      <div className="container mx-auto px-4 py-20 text-center relative z-10">
        <div className="max-w-4xl mx-auto animate-slide-up">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
            {t("hero.title")}
            <span className="block text-blue-light">{t("hero.subtitle")}</span>
          </h1>
          ...
          <div className="flex items-center justify-center space-x-6">
            <a href="https://www.linkedin.com/in/michael-m-87177793/" className="text-blue-light hover:text-white transition-colors transform hover:scale-110" aria-label="LinkedIn">
              <Linkedin className="w-6 h-6" />
            </a>
            <a href="https://github.com/MickyMik" className="text-blue-light hover:text-white transition-colors transform hover:scale-110" aria-label="GitHub">
              <Github className="w-6 h-6" />
            </a>
            <a href="mailto:contact@ditems.fr" className="text-blue-light hover:text-white transition-colors transform hover:scale-110" aria-label="Email">
